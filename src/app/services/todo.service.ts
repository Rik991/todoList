...
export class TodoService {
  ...
  getTodoWithUsers(user: iUser[]): iTodo[] {
  ...
  //funzione che tramite home-component viene scatenata al (change) della checkbox
  taskCompleted(task: iTodo) {
    task.completed = !task.completed;
    const index = this.todos.findIndex((t) => t.id === task.id); //con findindex trovo e poi aggiorno il task appena cekkato
